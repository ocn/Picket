...
**What to build:** Make every killmail embed identify the Final Blow beside the Victim using the same compact participant formatting and zKillboard links, while preserving the existing full-width Victim display when Final Blow data is absent.

**Blocked by:** None — can start immediately.

**Status:** claimed

- [ ] A marked character Final Blow renders immediately after Victim as a linked `[alliance ticker, else corporation ticker] Character` field.
...
- [ ] Victim and Final Blow share only the minimal participant-formatting code needed to keep their presentation consistent.
